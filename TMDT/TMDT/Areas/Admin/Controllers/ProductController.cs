...
namespace ProjectSEM3.Areas.Admin.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Create(Product product, IEnumerable<HttpPostedFileBase> MoreImage, long? sale, DateTime? beginDate, DateTime? endDate)
        {
        ...
        [HttpPost]
        public ActionResult Edit(Product product, IEnumerable<HttpPostedFileBase> MoreImage, long? sale, DateTime? beginDate, DateTime? endDate)
        {
            if (ModelState.IsValid)
            {
                //láy hình ảnh thêm vao trong thư mục data
